...
# Quick end-to-end demo for secure_packager using Docker CLI tools
# - Generates vendor and customer RSA keys
# - Creates a sample input file
# - Packages without license and with license using Docker CLI
# - Issues a vendor-signed token using Docker CLI
# - Unpacks both zips (license/non-license) using Docker CLI
# 
# This demonstrates using secure_packager via Docker without building locally.
# For Docker integration examples, see examples/example_docker/
